...
public class HomePage extends BasePage {
    ...
    private By formsCard = By.xpath("//div[@id='app']//div[.='Forms']");

    private By elementsCard = By.xpath("//div[@id='app']//div[.='Elements']");

    private By widgetsCard = By.xpath("//div[@id='app']//div[.='Widgets']");

    private By alertsFrameWindowsCard = By.xpath("//div[@id = 'app']//h5[contains(.,'Alerts')]");
